...
function imageToZ64(img, opts) {
    ...
    // กำหนดตัวเลือกเพิ่มเติมสำหรับการประมวลผลภาพ
    const enhancedOpts = {
        ...opts,
        contrast: opts.contrast || 15,  // เพิ่มคอนทราสต์เล็กน้อย
        sharpen: opts.sharpen || 2,     // เพิ่มความคมชัดเล็กน้อย
        dithering: opts.dithering || 'floyd-steinberg' // ใช้ Floyd-Steinberg dithering
    };
